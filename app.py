...
# as the pickel file size is about 110 mb to we compress it and then use it 
# decompressing the pickel file
...
def predict():
    ...
    if request.method == 'POST':
        ...
        stricker = int(request.form['stricker'])
        non_stricker = int(request.form['non_stricker'])
        
        temp_array = temp_array + [overs, runs, wickets,stricker, non_stricker]
